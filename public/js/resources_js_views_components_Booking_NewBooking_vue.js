      ...
      _vm.translation
        ? _c("main", { staticClass: "col-span-2 my-5 2xl:px-20" }, [
            _c("div", { staticClass: "flex flex-row" }, [
              _c(
                "div",
                { staticClass: "flex-none text-dbGray text-2xl font-bold" },
            ...
            !_vm.allowDateTime()
              ...
              ? _c("div", [
                          ...
                          _c("div", { staticClass: "grid grid-cols-3" }, [
                            _c("div", [
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.translation.dashboard.name) + ":"
                                  )
                                ]
                              ),
                              _vm._v(" "),
                      ...
                      _c("div", { staticClass: "grid grid-cols-3" }, [
                        _c("div", [
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.translation.booking.phone) + ":"
                              )
                            ]
                          ),
                          _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.translation.booking.venue) + ":"
                              )
                            ]
                          ),
                          _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.translation.booking.price) + ":"
                              )
                            ]
                          )
                        ]),
                        ...
                        _c("div", { staticClass: "col-span-2" }, [
                          _c("div", [
                            _vm._v(" " + _vm._s(_vm.venue.clubName) + " ")
                          ]),
                          _vm._v(" "),
                          _c("div", [
                            _vm._v(" " + _vm._s(_vm.venue.phone) + " ")
                          ]),
                          _vm._v(" "),
                          _c("div", [
                            _vm._v(" " + _vm._s(_vm.venue.sport_type) + " ")
                          ]),
                          _vm._v(" "),
                          _c("div", [
                            _vm._v(
                            ...
                            _vm.venue.indoor == 0
                              ? _c("span", [
                                  _vm._v(
                                    _vm._s(_vm.translation.booking.outdoor)
                                  )
                                ])
                              : _vm._e(),
                            _vm._v(")\n                                ")
                          ...
                          _c("div", [
                            _vm._v(
                              " " +
                                _vm._s(
                                  _vm.changeDateFormat(_vm.clubSearch.date)
                                ) +
                                " "
                            )
                          ]),
                              ...
                              "\n                                    " +
                                _vm._s(
                                  _vm.changeTimeFormat(
                                    _vm.clubSearch.start_time
                                  )
                                ) +
                                " - " +
                                _vm._s(
                                  _vm.changeTimeFormat(_vm.clubSearch.end_time)
                                ) +
                                "\n                                "
                            )
                          ]),
                  ...
                  _c("div", { staticClass: "bg-white p-3" }, [
                    ...
                    _c("div", [
                      _vm._v(
                        _vm._s(_vm.translation.booking.bookPage.infoCheckout)
                      )
                    ])
                  ])
                ])
    ...
    _vm.translation
      ? _c("div", { staticClass: "md:hidden px-3" }, [
          _c("div", { staticClass: "flex justify-between items-center my-3" }, [
            _c(
              "div",
              { staticClass: "lex-none text-2xl text-white font-bold" },
              [_vm._v(_vm._s(_vm.translation.booking.bookPage.title))]
            ),
            _vm._v(" "),
            _c(
              "button",
              {
                ...
                staticClass:
                  "flex-none h-8 bg-green-500 text-white px-8 focus:outline-none rounded-lg",
                on: { click: _vm.book }
              },
              [
                _vm._v(
                ...
                _c("div", { staticClass: "bg-white p-3 my-3 rounded-lg" }, [
                  ...
                  _c("div", { staticClass: "grid grid-cols-3" }, [
                    ...
                    _c("div", { staticClass: "col-span-2" }, [
                      ...
                      _vm._v(" "),
                      _c("div", [_vm._v(" " + _vm._s(_vm.venue.phone) + " ")]),
                      _vm._v(" "),
                      _c("div", [
                        _vm._v(" " + _vm._s(_vm.venue.sport_type) + " ")
                      ]),
                      ...
                      _c("div", [
                        _vm._v(
                          "\n                            " +
                            _vm._s(
                              _vm.changeTimeFormat(_vm.clubSearch.start_time)
                            ) +
                            " - " +
                            _vm._s(
                              _vm.changeTimeFormat(_vm.clubSearch.end_time)
