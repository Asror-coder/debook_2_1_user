<template>
    <div class="grid grid-cols-4 gap-4">
        ...
        <main class="col-span-2 flex justify-center mt-4">
            <div class="flex flex-col w-10/12 bg-white p-6 rounded-lg shadow-xl">
                ...
                <form @submit.prevent="register" class="mx-10 my-2">
                    <div class="mb-4">
                        ...
                        class="bg-gray-200 border-2 w-full p-2 rounded-lg focus:outline-none" v-model="form.name">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        class="bg-gray-200 border-2 w-full p-2 rounded-lg focus:outline-none" v-model="form.lastname">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        class="bg-gray-200 border-2 w-full p-2 rounded-lg focus:outline-none" v-model="form.phone">
                    </div>
