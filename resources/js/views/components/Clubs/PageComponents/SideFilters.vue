    ...
    <div>
        ...
        <div class="md:hidden">
            ...
            <div class="my-4">
                ...
                <div class="flex items-center justify-around" @change="changeRequest">
                    <div class="flex flex-col items-center">
                        <label class="text-white" for="20">€20</label>
                        <input type="radio" value="20" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="25">€25</label>
                        <input type="radio" value="25" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="30">€30</label>
                        <input type="radio" value="30" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="35">€35</label>
                        <input type="radio" value="35" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="40">€40</label>
                        <input type="radio" value="40" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="50">€50</label>
                        <input type="radio" value="50" v-model="form.maxPrice">
                    </div>

                    <div class="flex flex-col items-center">
                        <label class="text-white" for="0">{{ translation.clubs.d_matter }}</label>
                        <input type="radio" value="0" v-model="form.maxPrice">
                    </div>
                </div>
            </div>
