        ...
        <div class="slideshow-container">
            ...
            <div :key="image.id" v-for="(image, index) in images">
                <div class="fade" :class="slideIndex == index ? 'block' : 'hidden'">
                    <img :src="image.url" style="width:100%" class="object-cover h-48">
                </div>
            </div>
...
<template>
    <div v-if="images" class="relative">
        <carousel :perPage="1" :paginationPadding="4">
            <slide :key="image.id" v-for="image in images" v-show="images">
                <img :src="image.url" style="width:100%" class="object-cover h-52">
            </slide>
        </carousel>
    </div>
</template>
